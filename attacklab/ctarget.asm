...
00000000004017a8 <getbuf>:
  4017a8:	48 83 ec 28          	sub    $0x28,%rsp #BUFFER_SIZE=40
  4017ac:	48 89 e7             	mov    %rsp,%rdi #0x5561dc78 cookie:0x59b997fa 
...
000000000040184c <hexmatch>:
  ...
  401861:	00 00 
  401863:	48 89 44 24 78       	mov    %rax,0x78(%rsp) #initialize cbuf[100],address:0x5561dc70
  401868:	31 c0                	xo    %eax,%eax
  ...
  40189f:	48 8d 1c 0c          	lea    (%rsp,%rcx,1),%rbx #calc the random address
  4018a3:	45 89 e0             	mov    %r12d,%r8d #put cookie as unsigned in argument
  4018a6:	b9 e2 30 40 00       	mov    $0x4030e2,%ecx
  4018ab:	48 c7 c2 ff ff ff ff 	mov    $0xffffffffffffffff,%rdx
  4018b2:	be 01 00 00 00       	mov    $0x1,%esi
  4018b7:	48 89 df             	mov    %rbx,%rdi #destiantion buffer
